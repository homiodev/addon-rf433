...
public class RF433Controller {
  ...
  private static final String[] BUCKETS =
      new String[]{"#2f4554", "#c23531", "#e530cd", "#5cd538", "#7ca470", "#2787c7", "#27c7b4", "#b23ddc", "#8500b6",
          "#f510a1",
  ...
  /*  @RequestMapping(value = "/testRf433Transmitter", method = RequestMethod.POST)
   ...
   /* @RequestMapping(value = "/recordRf433", method = RequestMethod.POST)
    ...
    /*private Rf433Manager.RF433Signal buildRf433Signal(@RequestBody Rf433JSON rf433JSON) throws IOException,
